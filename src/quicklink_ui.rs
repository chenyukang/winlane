...
use crate::snippet_ui::input;
use objc2::rc::Retained;
use objc2::runtime::{AnyObject, ProtocolObject};
use objc2::{DefinedClass, MainThreadOnly, define_class, msg_send, sel};
use objc2_app_kit::*;
use objc2_foundation::{
    MainThreadMarker, NSNotification, NSObject, NSObjectProtocol, NSSize, NSString, NSURL, NSUUID,
};
...
pub fn render(
    ...
    template.render(clipboard, values, |kind, format| {
        ...
        winlane::snippets::Template::parse(&body)
            .and_then(|template| crate::snippet_ui::render(&template, "", &HashMap::new()))
            .unwrap_or_default()
    })
}
