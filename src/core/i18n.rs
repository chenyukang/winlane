...
macro_rules! tr {
    ($chinese:literal, $english:literal) => {
        match $crate::core::i18n::locale() {
            $crate::core::i18n::Locale::Chinese => $chinese,
            $crate::core::i18n::Locale::English => $english,
        }
    };
}
...
macro_rules! trf {
    ($chinese:literal, $english:literal $(, $($args:tt)*)?) => {
        match $crate::core::i18n::locale() {
            $crate::core::i18n::Locale::Chinese => format!($chinese $(, $($args)*)?),
            $crate::core::i18n::Locale::English => format!($english $(, $($args)*)?),
        }
    };
}
