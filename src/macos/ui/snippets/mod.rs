use crate::macos::platform::template_context::{render, render_with_preview};
use crate::macos::ui::controls::{button, hint, input, label, preferences_window, rect, text_area};
use crate::macos::ui::snippets::placeholder::{BuilderMode, PlaceholderBuilder};
...
use winlane::features::snippets::{ArgumentKind, Snippet, Template};
use winlane::{tr, trf};
...
impl SnippetEditor {
    ...
    fn insert_token(&self, token: &str) {
        ...
        match winlane::features::snippets::inserting(
    ...
    fn persist(&self) {
        ...
        let result = winlane::features::snippets::validate(&candidate)
...
#[cfg(test)]
#[allow(dead_code)]
#[path = "../../../../tests/native/snippet_ui.rs"]
pub(crate) mod tests;
