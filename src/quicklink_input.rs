use crate::settings::{button, label, rect};
...
use winlane::config::DisplayDensity;
use winlane::quicklinks::{Quicklink, Template};
use winlane::snippets::{Argument, ArgumentKind};
use winlane::tr;
...
impl Input {
    ...
    pub fn destination(&self) -> Result<String, String> {
        crate::quicklink_ui::render(&self.template, &self.clipboard, &self.values)
    }
