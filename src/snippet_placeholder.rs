...
use crate::snippet_ui::{SnippetEditor, input, render, text_area};
...
use winlane::snippets::{Argument, ArgumentKind, DATE_PRESETS, Template, date_placeholder};
use winlane::{tr, trf};
        ...
        if mode == BuilderMode::Date {
            ...
            for preset in DATE_PRESETS {
                ...
                self.preset.addItemWithTitle(&NSString::from_str(&format!(
                    "{} · {}",
                    match winlane::i18n::locale() {
                        winlane::i18n::Locale::Chinese => preset.title_zh,
                        winlane::i18n::Locale::English => preset.title_en,
                    },
                    example
                )));
            }
