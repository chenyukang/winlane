...
2. Push a matching tag, such as `v0.8.2` for package version `0.8.2`:

   ```sh
   git tag -a v0.8.2 -m 'Winlane 0.8.2'
...
```text
Winlane-0.8.2-macos-arm64.dmg
Winlane-0.8.2-macos-arm64.zip
Winlane-0.8.2-macos-x86_64.dmg
Winlane-0.8.2-macos-x86_64.zip
SHA256SUMS
build-info.json
```
