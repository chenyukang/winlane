...
2. Push a matching tag, such as `v0.8.4` for package version `0.8.4`:

   ```sh
   git tag -a v0.8.4 -m 'Winlane 0.8.4'
...
```text
Winlane-0.8.4-macos-arm64.dmg
Winlane-0.8.4-macos-arm64.zip
Winlane-0.8.4-macos-x86_64.dmg
Winlane-0.8.4-macos-x86_64.zip
SHA256SUMS
build-info.json
```
