...
Switching across Spaces depends on macOS Mission Control settings and the target app. Winlane does not move windows between Spaces. Its recent-window order tracks selections made through Winlane, not every switch made through the Dock, mouse, or another tool.
